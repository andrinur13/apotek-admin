                ...
                <div class="ibox-content">
                    ...
                    <table ref="myFooTable" id="table-content" class="mt-4 footable table table-hover table-stripped" data-page-size="10" data-filter=#filter>
                        ...
                        <tbody class="table-bordered">
                            ...
                            <tr>
                                <td> {{$i}} </td>
                                <td> {{$iv->nomor_invoice}} </td>
                                <td> Rp. {{number_format($iv->total)}} </td>
                                <td>
                                    @if($iv->status == 'paid')
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary text-white btn-sm btn-circle" href="<?= 'invoice/detail/' . $iv->id_invoice; ?>">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                    <a class="btn btn-danger text-white btn-sm btn-circle" data-toggle="modal" data-target="#deleteProduct" v-on:click="handleDeleted({{$iv->id_invoice}})">
