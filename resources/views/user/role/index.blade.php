        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <button class="btn btn-sm btn-primary mt-2" data-toggle="modal" data-target="#addRole">
                    ...
                    <table ref="myFooTable" id="table-content" class="mt-4 footable table table-hover table-stripped" data-page-size="10" data-filter=#filter>
                        ...
                        <tbody class="table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{$p->name}}</td>
                                <td>
                                    <a class="btn btn-primary text-white btn-sm btn-circle" href="<?= $main_url . "/detail/$p->id" ?>">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                    <a class="btn btn-danger text-white btn-sm btn-circle" data-toggle="modal" data-target="#deleteProduct" v-on:click="handleDeleted({{$p->id}})">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <label class="font-weight-bold" for="nama_product">Role Name</label>
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Role Name">
                                    <div class="text-secondary mt-2 ml-2">Contoh : user</div>
                                </div>
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            handleDeleted: function(id) {
                document.getElementById('deleteRoleAction').action = '/dashboard/user/role/delete/' + id;
            },
